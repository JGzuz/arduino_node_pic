...
void loop() {
  ...
  if(digitalRead(push12)==1){
      while(digitalRead(push12)==1){;}
        switch(x){
          case 0: Serial_sim.println("1000000000");delay(100);Serial.println("1000000000");break;
          case 1: Serial_sim.println("1000000001");delay(100);Serial.println("1000000001");break;
          case 2: Serial_sim.println("1000000002");delay(100);Serial.println("1000000002");break;
          case 3: Serial_sim.println("1000000003");delay(100);Serial.println("1000000003");break;
          case 4: Serial_sim.println("1000000004");delay(100);Serial.println("1000000004");break;
          case 5: Serial_sim.println("1000000005");delay(100);Serial.println("1000000005");break;
          case 6: Serial_sim.println("1000000006");delay(100);Serial.println("1000000006");break;
          case 7: Serial_sim.println("1000000007");delay(100);Serial.println("1000000007");break;
          case 8: Serial_sim.println("1000000008");delay(100);Serial.println("1000000008");break;
          case 9: Serial_sim.println("1000000009");delay(100);Serial.println("1000000009");break;
          case 10: Serial_sim.println("1000000010");delay(100);Serial.println("1000000010");break;
          case 11: Serial_sim.println("1000000011");delay(100);Serial.println("1000000011");break;
          case 12: Serial_sim.println("1000000012");delay(100);Serial.println("1000000012");break;
